...
* [DNS](#DNS)
  ...
  * [Public, External DNS Zone](#PublicExternalDNSZone)
    * [Anycast Resolution](#AnycastResolution)
  * [Cross Project Binding](#CrossProjectBinding)
* [Cloud Armor](#CloudArmor)
  * [Cloud Armour Encompasses](#CloudArmourEncompasses)
  * [Cloud Armor Policies & Ordering](#CloudArmorPoliciesOrdering)
  * [How it works](#Howitworks)
  * [Example Policy Scopes](#ExamplePolicyScopes)
...
#### <a name='AnycastResolution'></a>Anycast Resolution
>>
...
### <a name='CloudArmourEncompasses'></a>Cloud Armour Encompasses

- Policies/Rules
- Allowlist / Denylist IP's

### <a name='CloudArmorPoliciesOrdering'></a>Cloud Armor Policies & Ordering
...
### <a name='ExamplePolicyScopes'></a>Example Policy Scopes
